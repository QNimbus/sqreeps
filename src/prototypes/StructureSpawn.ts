 ...
 */
StructureSpawn.prototype.maxCreep = function (this: StructureSpawn, role: string, partsLimit: number = 50): string | 0 | -1 | -2 | -4 | -3 | -5 | -6 | -7 | -8 | -9 | -10 | -11 | -12 | -14 | -15 {
    ...
    return this.createCreep(Array.prototype.concat(carryParts, workParts, moveParts), creepName, { role: role, room: this.room.name });
}
