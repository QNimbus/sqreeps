...
export class Qreep {
    ...
    public goTransfer(this: Qreep, target: Creep | Qreep | Structure, resourceType: ResourceConstant = RESOURCE_ENERGY, amount?: number): number {
    ...
    public goWithdraw(this: Qreep, target: Structure | Tombstone, resourceType: ResourceConstant = RESOURCE_ENERGY, amount?: number) {
    ...
    public transfer(this: Qreep, target: Creep | Qreep | Structure, resourceType: ResourceConstant = RESOURCE_ENERGY, amount?: number): number {
