...
export function hasPos(obj: IHasPos | RoomPosition): obj is IHasPos {
    return (<IHasPos>obj).pos !== undefined;
}
...
export function isSqreep(creep: Creep | Qreep): creep is Qreep {
    return (<Qreep>creep).creep !== undefined;
}
